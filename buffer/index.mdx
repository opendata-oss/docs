...
sinks can deduplicate correctly. See the [benchmarks](/buffer/benchmarks) for end-to-end
...
<CardGroup cols={2}>
  ...
  <Card title="When to choose Buffer" icon="scale-balanced" href="/buffer/comparisons">
