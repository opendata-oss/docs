...
sample has no causal relationship to the records around it. By skipping the
distributed-systems machinery those guarantees require, Buffer stays far simpler
and cheaper than a full log.
