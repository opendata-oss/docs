...
**…serving tens of thousands of live followers cheaply.** One node sustained
50,000 concurrent followers across 1M keys at 20 MB/s ingest with sub-50ms
p50, about \$224/month all-in. Each added reader node buys another ~50K
followers for ~\$174.
...
**…never operating a broker cluster.** All you need to run Log is one binary and an 
...
² NATS handles millions of subjects with superb latency, but replayable
...
young. The battle-tested open-source systems are funnels wearing the wrong
