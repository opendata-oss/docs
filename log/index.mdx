...
Object storage as the only durable layer makes Log strongly consistent, durable,
and cheap to operate. Read replicas scale linearly, and scoping a replica to a
